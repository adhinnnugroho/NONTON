<x-app-layout>
    ...
    <div>
        ...
        <div class="gap-[30px] __scroll-selector">
            ...
            <!-- Movie Thumbnail -->
            <div class="relative overflow-hidden group mr-[30px]">
                <img src="assets/images/featured-2.png" class="object-cover rounded-[30px] w-[520px] h-[340px]"
                    alt="" />
                <!-- rating -->
                <div class="rating absolute top-0 left-0">
                    <div class="p-[30px] flex items-center gap-1">
            ...
            <!-- Movie Thumbnail -->
            <div class="relative overflow-hidden group mr-[30px]">
                <img src="assets/images/featured-3.png" class="object-cover rounded-[30px] w-[520px] h-[340px]"
                    alt="" />
                <!-- rating -->
                <div class="rating absolute top-0 left-0">
                    <div class="p-[30px] flex items-center gap-1">
            ...
            <!-- Movie Thumbnail -->
            <div class="relative overflow-hidden group mr-[30px]">
                <img src="assets/images/featured-1.png" class="object-cover rounded-[30px] w-[520px] h-[340px]"
                    alt="" />
                <!-- rating -->
                <div class="rating absolute top-0 left-0">
                    <div class="p-[30px] flex items-center gap-1">
    ...
    <div class="mt-10">
        ...
        <div class="__scroll-selector">
            ...
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="assets/images/browse-1.png" class="object-cover rounded-[30px] h-[340px] w-[250px]"
                    alt="">
                <div
                ...
                <div
                    ...
                    <img src="assets/icons/ic_play.svg" class="" width="50" alt="">
                </div>
                <a href="watching.html" class="inset-0 absolute z-50"></a>
            </div>
            <!-- Movies 2 -->
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="assets/images/browse-2.png" class="object-cover rounded-[30px] h-[340px] w-[250px]"
                    alt="">
                <div
                    class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px]">
                    <div class="px-7 pb-7">
            ...
            <!-- Movies 3 -->
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="assets/images/browse-3.png" class="object-cover rounded-[30px] h-[340px] w-[250px]"
                    alt="">
                <div
                    class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px]">
                    <div class="px-7 pb-7">
            ...
            <!-- Movies 4 -->
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="assets/images/browse-4.png" class="object-cover rounded-[30px] h-[340px] w-[250px]"
                    alt="">
                <div
                    class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px]">
                    <div class="px-7 pb-7">
            ...
            <!-- Movies 5 -->
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="assets/images/browse-5.png" class="object-cover rounded-[30px] h-[340px] w-[250px]"
                    alt="">
                <div
                    class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px]">
                    <div class="px-7 pb-7">
