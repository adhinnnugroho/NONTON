            ...
            <div class="links flex flex-col mt-[60px] h-full gap-[50px]">
                ...
                <div>
                    ...
                    @if (Route::is('dashboard'))
                        <a href="{{ route('dashboard') }}"
                            class="border-r-[3px] border-alerange flex text-gray items-center font-normal text-sm w-full mb-5 gap-3 transition-all">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                                class="text-alerange" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @else
                        <a href="{{ route('dashboard') }}"
                            class="flex items-center font-normal text-black text-sm w-full mb-5 gap-3 transition-all">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                    ...
                    <a href="#!"
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" class="text-[#B7B7B7]"
                ...
                <div>
                    ...
                    @if (Route::is('layanan.produk'))
                        <a href="{{ route('layanan.produk') }}"
                            class="border-r-[3px] border-alerange flex text-gray items-center font-normal text-sm w-full mb-5 gap-3 transition-all">
                            <svg width="24" height="24" viewBox="0 0 24 24" class="text-alerange"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="mt-auto pr-[30px]">
                    <div class="p-5 bg-black rounded-[25px]">
                        <img src="{{ asset('/assets/icons/ic_star-rounded.svg') }}" alt="">
