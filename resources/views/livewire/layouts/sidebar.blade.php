        ...
        <div class="flex flex-col p-[30px] pr-0 border-r border-gray-[#F1F1F1] overflow-y-auto h-full">
            ...
            <div class="links flex flex-col mt-[60px] h-full gap-[50px]">
                ...
                <div>
                    ...
                    <a href="/"
                        class="font-semibold border-r-[3px] border-alerange flex text-gray items-center font-normal text-sm w-full mb-5 gap-3 transition-all">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="text-alerange"
