        ...
        <div class="flex justify-center gap-10 mt-[70px]">
            ...
            <div
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex items-center gap-2">
                        <img src="{{ asset('/assets/icons/ic_tick.svg') }}" alt="" />
                        <span class="text-sm">
            ...
            <div
                ...
                <div class="bg-alerange rounded-full p-[13px] max-w-max">
                    <img src="{{ asset('/assets/icons/ic_star.svg') }}" width="24" alt="">
                </div>
                <!-- Top Content: Name-Price -->
                <div>
                ...
                <!-- Bottom: CTA Button -->
                <div>
                    <a href="payment_status/success.html" class="rounded-2xl bg-alerange py-[13px] text-center grid">
