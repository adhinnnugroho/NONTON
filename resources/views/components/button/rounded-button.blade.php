<button
    {{ $attributes->merge([
        ...
        disabled:transform-none disabled:cursor-not-allowed disabled:transform-none
        disabled:transition-none disabled:opacity-75 transition duration-200 ease-in-out',
    ]) }}>
    {{ $slot }}
</button>
